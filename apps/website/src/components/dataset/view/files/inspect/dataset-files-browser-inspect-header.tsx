...
import { DatasetFilesBrowserInspectDirectoryViewType } from "@/components/dataset/view/files/inspect/dataset-files-browser-inspect-directory-view-type";
...
export function DatasetFilesBrowserInspectHeader({ dataset }: Props) {
  ...
  return (
    <div className="flex h-11 items-center justify-between gap-x-2 border-b p-1">
