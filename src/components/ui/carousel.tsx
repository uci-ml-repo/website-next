...
>(({ className, gutter, ...props }, ref) => {
  ...
  return (
    <>
      ...
      <div ref={carouselRef} className={cn("overflow-hidden", gutter ? "-m-3 -mb-6 p-3 pb-6" : "")}>
        <div
          ref={ref}
          className={cn(
            "flex",
...
>(({ className, variant = "outline", size = "icon", staticPositioning, ...props }, ref) => {
...
const CarouselScrollDots = ({ api, className }: { api: CarouselApi; className?: string }) => {
